 ...
 **/
@Mapper
public interface FlightRecordsMapper {
     ...
     * @return
     */
    List<FlightRecords> findFlightRecordsById(@Param("flightNumber") String flightNumber);
     ...
     * @return
     */
    FlightRecords findFlightRecordsByIdCity(@Param("flightId") Integer flightId);
     ...
     * @return
     */
    FlightRecords findFlightRecordsByIdFlightRecords(@Param("flightId") Integer flightId);
